...
// On prend le MAX des 2 rendements (présent et optimisé)
// Logique : si l'un des 2 est OK, le mandat est éligible
// ─────────────────────────────────────────────────────────
function checkRendement(mandat, client) {
  ...
  // Si aucun des 2 rendements n'est renseigné
  ...
  // Précise lequel des 2 a atteint le seuil
