...
export function googleSatelliteUrl({ lat, lng, zoom = 18, width = 600, height = 400 }) {
  // OpenStreetMap via Esri World Imagery (satellite gratuit, sans cl\u00e9)
  // Utilise staticmap.openstreetmap.de pour la vue carte ET le service Esri pour le satellite via tiles
  const params = new URLSearchParams({
    center: `${lat},${lng}`,
    zoom: String(zoom),
    size: `${width}x${height}`,
    maptype: 'mapnik', // mapnik = carte routi\u00e8re standard
