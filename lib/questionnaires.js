    ...
    // ─── SECTION 2 : PROJET D'ACQUISITION ─────────────────
    {
      ...
      questions: [
        ...
        { id: 'familles_recherchees', label: 'Types d\'actifs recherchés',
          ...
          // Ordre d'affichage + filtre (Résidentiel exclu, c'est pour B2C)
          order: ['Immeubles', 'Locaux commerciaux', 'Hôtels', 'Terrains', 'Parking'],
          subKeys: {
            'Immeubles': 'sous_types_immeubles',
            'Hôtels': 'sous_types_hotels',
            'Locaux commerciaux': 'sous_types_locaux'
          },
          hint: 'Sélectionnez les types qui vous intéressent' },
