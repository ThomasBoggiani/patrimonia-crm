...
// v2 (25 mai 2026) : refonte B2B Acquéreur — 5 sections, +questions stratégiques
...
// ─────────────────────────────────────────────────────────
// TEMPLATE ACQUÉREUR B2B (Investissement) — v2 REFONTE
// ─────────────────────────────────────────────────────────
export const QUESTIONNAIRE_ACQUEREUR_B2B = {
  type: 'acquereur',
  marche: 'b2b',
  nom: 'Investissement immobilier',
  description: 'Définissez votre projet d\'acquisition en quelques minutes',
  sections: [
    // ─── SECTION 1 : VOUS ─────────────────────────────────
    {
      id: 'identite',
    ...
    // ─── SECTION 2 : VOTRE PROJET D'ACQUISITION ──────────
    {
      id: 'projet',
      ...
      icon: '🎯',
      questions: [
        { id: 'familles_recherchees', label: 'Familles d\'actifs recherchées', type: 'multiselect',
          required: true, options: TYPES_ACTIF_B2B_FAMILLES,
          hint: 'Sélectionnez tout ce qui vous intéresse — vous pourrez préciser ensuite' },
        ...
        { id: 'rendement_min', label: 'Rendement minimum visé', type: 'number', required: false,
          ...
          hint: 'Optionnel — Net vendeur ou Brut au choix' },

        { id: 'zones', label: 'Zones géographiques', type: 'multiselect', required: true,
          options: ZONES, hint: 'Plus de zones = plus d\'opportunités à vous proposer' },
    ...
    // ─── SECTION 3 : CAPACITÉ D'ACQUISITION ───────────────
    {
      id: 'capacite',
    ...
    // ─── SECTION 5 : MIEUX VOUS CONNAÎTRE ─────────────────
    {
      ...
      questions: [
        ...
        { id: 'ticket_moyen', label: 'Ticket moyen historique', type: 'number',
        ...
        { id: 'commentaires', label: 'Quelque chose à ajouter ?',
          type: 'textarea', required: false, rows: 3,
          placeholder: 'Tout ce que vous souhaitez partager : critères particuliers, contexte de votre recherche, événement déclencheur...' }
      ]
    }
  ]
};
...
// ─────────────────────────────────────────────────────────
// TEMPLATE ACQUÉREUR B2C (Habitation) — inchangé
// ─────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────
// TEMPLATE VENDEUR B2B (Investissement) — refonte en Phase 3
// ─────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────
// TEMPLATE VENDEUR B2C (Habitation) — inchangé
// ─────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────
// Helpers d'import CRM — v2 enrichi avec nouvelles questions B2B
// ─────────────────────────────────────────────────────────
