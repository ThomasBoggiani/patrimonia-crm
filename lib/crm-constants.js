...
// ─────────────────────────────────────────────────────────
// ARBORESCENCE TYPES D'ACTIF (mandats)
...
// Liste plate des familles (pour les dropdowns simples)
export const TYPES_ACTIF_FAMILLES = Object.keys(TYPES_ACTIF_TREE);

// Liste plate de TOUS les types (famille + sous-types) pour rétrocompatibilité
// avec les données existantes en BDD qui peuvent utiliser des anciennes valeurs
...
// ─────────────────────────────────────────────────────────
// ARBORESCENCE TYPOLOGIES CLIENTS
// Famille -> [sous-types] (vide = pas de sous-type)
// ─────────────────────────────────────────────────────────
