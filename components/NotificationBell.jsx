    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-cream-dark rounded-xl shadow-luxe-hover z-50 max-h-[70vh] overflow-hidden flex flex-col">
